 ...
 * @author User
 */
public class TravelAgencyMngArea extends javax.swing.JPanel {

    /**
     * Creates new form TravelAgencyMngArea
     */
    private JPanel cardSequenceJPanel;
    private TravelAgency travelAgency;
    private Airliner airliner;
    public TravelAgencyMngArea(JPanel cardSequenceJpanel, TravelAgency travelAgency) {
        initComponents();
    ...
    SimpleDateFormat f = new SimpleDateFormat("MM/dd/yy");
        ...
        for(Airliner airliner:travelAgency.getAirlinerDirectory().getAirlinerList()) {
            ...
            row[9]=airliner.getFlightList().get(i).getTotalSeats();
            dtm.addRow(row);
            count++;
            }
            i++;
    ...
    private void initComponents() {
        ...
        tbltravelagency.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Airliner", "Flight Number", "Source", "Destination", "Departure time", "Departure Date", "Arrival Time", "Arrival Date", "Price", "Total Seats"
            }
        ) {
    ...
    private void btnViewFlightDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewFlightDetailsActionPerformed
        ...
        int selectedRow = tbltravelagency.getSelectedRow();
         if(selectedRow<0) {
           ...
           Flight flight = (Flight)tbltravelagency.getValueAt(selectedRow,1);
           ViewFlight panel = new ViewFlight(cardSequenceJPanel,flight);
