    ...
    private void btnBookAFlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookAFlightActionPerformed
        ...
        try{
            for(Customer customer : travelAgency.getCustomerDirectory().getCustomerDirectory()){
                if(customer.getCustomerName()==customerName && customer.getCustomerEmail()==customerEmail){
                    if(flightNumber==customer.getFlightNumber()){
            ...
            JOptionPane.showMessageDialog(null, "Sorry u have clashing flights ");
            return;
        }
