...
SimpleDateFormat f = new SimpleDateFormat("MM/dd/yy");
    public FlightSearchArea(JPanel cardSequenceJPanel, TravelAgency travelAgency) {
        initComponents();
        ...
        for (Airliner airliner : travelAgency.getAirlinerDirectory().getAirlinerList()) {
            ...
            for (Flight flight : airliner.getFlightList()) {
                ...
                if (airliner.getAirlinerName().equals(flight.getAirlinerName())) {
                    ...
                    row[5] = f.format(airliner.getFlightList().get(i).getDepDate());
                    row[6] = airliner.getFlightList().get(i).getArrivalTime();
                    row[7] = f.format(airliner.getFlightList().get(i).getArrDate());
                    row[8] = airliner.getFlightList().get(i).getFlightPrice();
                    row[9] = airliner.getFlightList().get(i).getAvailableSeats();
                    dtm.addRow(row);
                    count++;
                }
                i++;
    ...
    private void initComponents() {
        ...
        ViaBox = new javax.swing.JComboBox<>();
        ...
        tbltravelagency.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Airliner", "Flight Number", "Source", "Destination", "Departure time", "Departure Date", "Arrival Time", "Arrival Date", "Price", "Available Seats"
            }
        ) {
        ...
        btnSearchFlight.setForeground(new java.awt.Color(0, 0, 204));
        ...
        ViaBox.setToolTipText("");
        ViaBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ViaBoxActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(ViaBox, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(43, 43, 43)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ViaBox, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBookAFlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookAFlightActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            BookFlightPanel panel = new BookFlightPanel(cardSequenceJPanel, flight, travelAgency);
    ...
    private void btnSearchFlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchFlightActionPerformed
        ...
        try {
            ...
            String via = String.valueOf(ViaBox.getSelectedItem());
            double minPrice;
            double maxPrice;
                ...
                for (Flight flight : airliner.getFlightList()) {
                    ...
                    if (airliner.getAirlinerName().equals(flight.getAirlinerName())) {
                        if (flight.getSource().equals(source) && flight.getDestination().equals(destination) && flight.getFlightPrice() > minPrice && flight.getFlightPrice() < maxPrice) {
                            ...
                            if (Integer.parseInt(flight.getDepartureTime().substring(0, 2)) >= timeMin && Integer.parseInt(flight.getDepartureTime().substring(0, 2)) <= timeMax) {
                                Object[] row = new Object[10];
                                System.out.println(flight.getDepartureTime().substring(0, 2) + "ky");
                                row[0] = airliner.getAirlinerName();
                                row[1] = flight;
                                row[2] = airliner.getFlightList().get(i).getSource();
                                row[3] = airliner.getFlightList().get(i).getDestination();
                        ...
                        } else if (flight.getSource().equals(source) || flight.getDestination().equals(destination) && minPrice == 0.0 && maxPrice == 0.0 && via.isEmpty()==false ) {
                            if (flight.getSource().equals(source) == flight.getDestination().equals(via) && flight.getDestination().equals(via) == flight.getSource().equals(destination)) {
                                Object[] row = new Object[10];
                                System.out.println(flight.getDepartureTime().substring(0, 2) + "ky");
                                row[0] = airliner.getAirlinerName();
                                row[1] = flight;
    ...
    private void ViaBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViaBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ViaBoxActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<String> ViaBox;
