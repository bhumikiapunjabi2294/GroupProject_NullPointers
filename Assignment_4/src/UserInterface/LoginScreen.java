...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
       ...
       // String value = comboUser.getSelectedItem().toString();
       int value = comboUser.getSelectedIndex();
       
       System.out.println( list.get(0));
      boolean b =  list.get(value).verify(txtPword.getText());
     //   String passWord = u;
        if (b==true){
         CardLayout layout = (CardLayout)panelRight.getLayout();
        panelRight.add(new SuccessScreen(list.get(value)));
    ...
    private void initialize(){
        //text should either be "Airliner Login Screen" OR "Customer Login Screen"
       ...
       //list.get(0).getRole();
        txtTitle.setText(list.get(0).getRole() +" Login Screen");
            ...
            JOptionPane.showMessageDialog(null,"Please Enter User First");
            return;
            
        }
        //  comboUser.addItem(list.get(0));
