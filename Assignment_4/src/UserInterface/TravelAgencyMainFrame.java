 ...
 * @author mayur
 */
public class TravelAgencyMainFrame extends javax.swing.JFrame {

    /**
     * Creates new form TravelAgencyMainFrame
     */
    private TravelAgency travelAgency;
    public TravelAgencyMainFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TravelAgencyMainFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TravelAgencyMainFrame().setVisible(true);
            }
        });
    }
