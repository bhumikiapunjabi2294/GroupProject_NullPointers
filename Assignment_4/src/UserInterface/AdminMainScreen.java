...
public class AdminMainScreen extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tableSup.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Airliners Name", "Number of  Flights"
            }
        ));
    ...
    public void populate(){
        ...
        dtm.setRowCount(0);
        for(User u : admin.getAirlinerDirectory().getAirlinerList()){
        ...
        DefaultTableModel d = (DefaultTableModel)tableCust.getModel();
        d.setRowCount(0);
        for(User us : admin.getCustDir().getCustomerList()){
            Customer s = (Customer)us;
